...
public class TerrainRenderer {
    ...
    // binds and unbinds Variables enables and disables rendering specific settings and DRAWs the terrain
    public void render(List<Terrain> terrains) {
        for (Terrain terrain : terrains) {
            prepareTerrain(terrain);
            loadModelMatrix(terrain);
            GL11.glDrawElements(GL11.GL_TRIANGLES, terrain.getModel().getVertexCount(), GL11.GL_UNSIGNED_INT, 0); // DRAW Terrain
            unbindTexturedModel();
        }
